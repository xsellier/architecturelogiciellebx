...
public class IntersectTools {
	...
	/**
	 * Return a polygonal zone (with max 6 sides) containing the whole path along 
	 * the next step move.
	 *
	 * @return Either a {@link java.awt.Rectangle rectangle} or an
	 *         {@link java.awt.Polygon hexagon}.
	 */
	public static Shape getIntersectShape(Movable movable, SpeedVector speedVector) {
		// Compute the intersection shape using the movable properties
		int dX = (int) speedVector.getDir().getX();
		int dY = (int) speedVector.getDir().getY();
